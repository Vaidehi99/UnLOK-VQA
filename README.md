...
Save the UNLOK-VQA.json file in the "DATA_DIR" path in ```globals.yml``` as ```zsre_mend_eval.json```
...
This is built on top of code from [LLaVA](https://github.com/haotian-liu/LLaVA) and [Belief-localization](https://github.com/google/belief-localization)
...
### **Installing LLaVA**
To set up **LLaVA**, clone the repository and install the required dependencies:
This is the version 1.1.1 of the [LLaVA](https://github.com/haotian-liu/LLaVA) installation compatible with this codebase.
```bash
cd LLaVA
pip install -e .
```
