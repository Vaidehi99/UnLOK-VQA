...
class args:
    model_path = "/nas-ssd2/vaidehi/projects/LLaVA/checkpoints/llava-v1.5-7b-task-lora/" #"liuhaotian/llava-v1.5-13b"#"liuhaotian/llava-v1.5-7b" #"liuhaotian/llava-v1-0719-336px-lora-vicuna-13b-v1.3" #"liuhaotian/llava-v1-0719-336px-lora-merge-vicuna-13b-v1.3"
    ...
    size = 10000
    save = False
    save_path = "/nas-ssd2/vaidehi/projects/LLaVA/checkpoints/llava-v1.5-7b-task-lora-merged/"
