...
class args:
    model_path = "/nas-ssd/vaidehi/LLaVA_v1.6_data/llava_v1.6_mistral_base_full_round1_4_10_1e-5"#"liuhaotian/llava-v1.6-mistral-7b" #"llava-hf/llava-v1.6-mistral-7b-hf" #"liuhaotian/llava-v1.6-mistral-7b" #"liuhaotian/llava-v1.5-13b"#"liuhaotian/llava-v1.5-7b" #"liuhaotian/llava-v1-0719-336px-lora-vicuna-13b-v1.3" #"liuhaotian/llava-v1-0719-336px-lora-merge-vicuna-13b-v1.3"
    image_file = "/nas-ssd2/vaidehi/projects/WikiWeb2M/images-filter/{}"
    load_8bit = False
    model_base = None#"liuhaotian/llava-v1.6-mistral-7b"#None #"lmsys/vicuna-13b-v1.3"
    device = "cuda"
    conv_mode = None
    temperature = 0.2
    max_new_tokens = 512
    ...
    out_path = "/nas-ssd/vaidehi/LLaVA_v1.6_data/llava_v1.6_7b_base_ft_summ_{}_{}.csv"
...
def eval_model(args):
    ...
    # tokenizer, model, image_processor, context_len = load_pretrained_model("liuhaotian/llava-v1.6-mistral-7b", args.model_base, model_name, args.load_8bit, args.load_4bit, device=args.device)
    ...
    data["llava_v1.6_7b_base_ft"] = summaries
