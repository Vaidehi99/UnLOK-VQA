...
class args:
    model_path = "liuhaotian/llava-v1.5-7b" #"liuhaotian/llava-v1.5-13b"#"liuhaotian/llava-v1.5-7b" #"liuhaotian/llava-v1-0719-336px-lora-vicuna-13b-v1.3" #"liuhaotian/llava-v1-0719-336px-lora-merge-vicuna-13b-v1.3"
    image_file = "/nas-ssd2/vaidehi/projects/WikiWeb2M/images-filter/{}"
    load_8bit = False
    model_base = None #"liuhaotian/llava-v1.5-7b"
    device = "cuda"
    conv_mode = None
    temperature = 0.2
    max_new_tokens = 512
