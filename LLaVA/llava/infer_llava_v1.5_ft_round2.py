...
class args:
    model_path = "/nas-ssd2/vaidehi/projects/LLaVA/checkpoints/llava-v1.5-7b-task-lora_round_2/" #"liuhaotian/llava-v1.5-13b"#"liuhaotian/llava-v1.5-7b" #"liuhaotian/llava-v1-0719-336px-lora-vicuna-13b-v1.3" #"liuhaotian/llava-v1-0719-336px-lora-merge-vicuna-13b-v1.3"
    ...
    debug = True
    data_path = "/nas-ssd2/vaidehi/projects/WikiWeb2M/train_zeroshot_llava_v1.5_13b_all_filt.csv" #"/nas-ssd2/vaidehi/projects/WikiWeb2M/data_test_valid_urls_desc_summ_unieval_scores.csv"
    img_dir = "/nas-ssd2/vaidehi/projects/WikiWeb2M/images-filter/"
    j = 0
    size = 5000
    save = True
    save_path = "/nas-ssd2/vaidehi/projects/LLaVA/checkpoints/llava-v1.5-7b-task-lora-merged_finetuned_filter_8_round2/"
