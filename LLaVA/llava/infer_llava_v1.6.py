...
def run_llava(args):
    ...
    model = LlavaNextForConditionalGeneration.from_pretrained("llava-hf/llava-v1.6-mistral-7b-hf", low_cpu_mem_usage=True).to("cuda:0")
...
class args:
    model_path = "llava-hf/llava-v1.6-mistral-7b-hf" #"liuhaotian/llava-v1.5-13b"#"liuhaotian/llava-v1.5-7b" #"liuhaotian/llava-v1-0719-336px-lora-vicuna-13b-v1.3" #"liuhaotian/llava-v1-0719-336px-lora-merge-vicuna-13b-v1.3"
    ...
    debug = True
    data_path = "/nas-ssd/vaidehi/LLaVA_v1.6_data/train_llava_v1.6_7b_zs_summ_all.csv"#"/nas-ssd2/vaidehi/projects/WikiWeb2M/data_v1.6.csv"
    # data_path = "/nas-ssd2/vaidehi/projects/WikiWeb2M/{}_zeroshot_llava_v1.5_13b_all_filt.csv"
    out_path = "/nas-ssd/vaidehi/LLaVA_v1.6_data/llava_v1.6_7b_zs_summ_{}.csv"
