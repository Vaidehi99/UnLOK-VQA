...
class args:
    model_path = "/nas-ssd/vaidehi/LLaVA_v1.6_data/merged_ckpt" #"liuhaotian/llava-v1.5-13b"#"liuhaotian/llava-v1.5-7b" #"liuhaotian/llava-v1-0719-336px-lora-vicuna-13b-v1.3" #"liuhaotian/llava-v1-0719-336px-lora-merge-vicuna-13b-v1.3"
    image_file = "/nas-ssd2/vaidehi/projects/WikiWeb2M/images-filter/{}"
    load_8bit = False
    model_base = None #"llava-hf/llava-v1.6-mistral-7b-hf" #"lmsys/vicuna-13b-v1.3"
    device = "cuda"
    conv_mode = None
    temperature = 0.2
    max_new_tokens = 512
