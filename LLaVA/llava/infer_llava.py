...
class args:
    model_path = "liuhaotian/llava-v1-0719-336px-lora-vicuna-13b-v1.3" #"liuhaotian/llava-v1-0719-336px-lora-merge-vicuna-13b-v1.3"
    image_file = "/nas-ssd2/vaidehi/projects/WikiWeb2M/images-filter/{}"
    load_8bit = False
    model_base = "lmsys/vicuna-13b-v1.3"
    device = "cuda"
    conv_mode = None
    temperature = 0.2
    max_new_tokens = 512
    ...
    txt = "Combine the following text with the image content coherently and summarize including content from both the text and the image in less than 4 sentences: {}"
    debug = True
